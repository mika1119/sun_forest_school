...
<section>
  {% include parts/title.html id="feature" title="園の特徴" %}
  {% include sections/panel.html %}
</section>

<section>
  {% include parts/title.html id="class" title="クラス紹介" %}
  {% include sections/card.html %}
</section>

<section>
  {% include parts/title.html id="schedule" title="1日の流れ" %}
  {% include parts/tab.html %}
</section>

<section>
  {% include parts/title.html id="news" title="お知らせ" %}
